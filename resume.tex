...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \small{Male, 29 Years} &  \href{mailto:itsrakesh13@gmail.com}{itsrakesh13@gmail.com }\textbar{ +91-9958843603} \\
\end{tabular*}

%-----------EDUCATION-----------------
\section{Professional Overview}
\begin{itemize}[leftmargin=4 mm] \setlength{\itemsep}{0pt}
  \item	6 Years of competitive work experience in designing and developing of Web applications and software solutions. 
\item	Strong personal ownership and ability to set and meet high professional standards. 
\item Polyglot developer with a great background in the IT sector.
...
\resumeSubHeadingListStart
     \resumeItem{Languages}{Java, Golang, Python, JavaScript}
     \resumeItem{Databases}{ MySql, Mongo, Cassandra, Redis, CouchDB}
     \resumeItem{Tools}{GIT, JIRA, NewRelic, Docker, Grafana, Prometheus, AWS, Kubernetes}
     \resumeItem{System Skills}{Distributed System, System Design and Architect, Algorithms.}
     \resumeItem{Interest} {Distributed Computing, Machine Learning and Artificial Intelligence}
 \resumeSubHeadingListEnd
...
\begin{itemize}[leftmargin=4 mm] \setlength{\itemsep}{0pt}
    \item Won Hackathon Competition held at OyoRooms.
     \item Training and Placement coordinator at NIT Allahabad.
      \item 40K hits on app in single day which i made at College.
     \item Awarded as a rock star employee at Tolexo.
      \item Won lecture competition held at District school.
\end{itemize}
